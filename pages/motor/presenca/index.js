...
export default function Equipes() {
    return (
      ...
      <View style={styles.column}>
        ...
        <TouchableOpacity >
                <Text style={styles.info}>Isabelle Vidal                    15:30</Text>
            </TouchableOpacity>

              
            <TouchableOpacity >
                <Text style={styles.info}>Maria Júlia                        15:40</Text>
            </TouchableOpacity>

            
              
            <TouchableOpacity >
                <Text style={styles.info}>Isabelle Vidal                    15:45</Text>
            </TouchableOpacity>

            
              
            <TouchableOpacity >
                <Text style={styles.info}>Maria Júlia                        15:50</Text>
            </TouchableOpacity>

            <TouchableOpacity >
                <Text style={styles.info}>Isabelle Vidal                    15:55</Text>
            </TouchableOpacity>

   
            <TouchableOpacity >
                <Text style={styles.info}>Maria Júlia                        15:10</Text>
            </TouchableOpacity>
